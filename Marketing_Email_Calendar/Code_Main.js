function sendCompanyOutreach() {
  ...
  const cols = {
    ...
    attachment2: getColIndex('Attachment 2')
  };
  ...
  for (let i = 1; i < data.length; i++) {
    ...
    const calendarLink = row[cols.attachment] || "https://edubridge-academy.com/calendar"; // Calendar link
    const brochureLink = row[cols.attachment2] || "https://edubridge-academy.com/brochure"; // Brochure link
            ...
            <td style="padding: 15px 20px;">
                ...
                <div class="action-box" style="background-color: #e6f7ff; padding: 15px 20px; border-radius: 4px; margin-bottom: 25px;">
                  <p style="margin-top: 15px; margin-bottom: 15px;">
                    <a href="${calendarLink}" class="action-button" style="display: inline-block; background-color: #2b6cb0; color: white; padding: 8px 16px; text-decoration: none; border-radius: 4px; font-weight: bold; margin-right: 10px;">VIEW OUR TRAINING CALENDAR</a>
                  </p>
                  <p style="margin-top: 15px;">
                    <a href="${brochureLink}" class="action-button" style="display: inline-block; background-color: #2b6cb0; color: white; padding: 8px 16px; text-decoration: none; border-radius: 4px; font-weight: bold;">DOWNLOAD OUR PROGRAM BROCHURE</a>
                  </p>
                </div>
...
VIEW OUR TRAINING CALENDAR: ${calendarLink}
DOWNLOAD OUR PROGRAM BROCHURE: ${brochureLink}
